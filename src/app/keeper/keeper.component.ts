...
export class KeeperComponent implements OnInit {
  ...
  public updateScore(scores: any) {
    ...
    score.playByPlay = new Announcer(value["playByPlay-announcerName"], value["playByPlay-title"], value["playByPlay-subtitle"], value["playByPlay-screenOrder"]);
    score.colorCommentary = new Announcer(value["colorCommentary-announcerName"], value["colorCommentary-title"], value["colorCommentary-subtitle"], value["colorCommentary-screenOrder"]);
    score.fieldReporter = new Announcer(value["fieldReporter-announcerName"], value["fieldReporter-title"], value["fieldReporter-subtitle"], value["fieldReporter-screenOrder"]);
    score.player = new Announcer(value["player-announcerName"], value["player-title"], value["player-subtitle"], value["player-screenOrder"]);
